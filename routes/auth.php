...
Route::middleware('auth')->group(function () {
  ...
  Route::group(['prefix' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'customers'], function () {
      ...
      Route::get(
        '/',
        [\App\Http\Controllers\Customer\CustomerController::class, 'index'],
      )->name('auth.customer.index');

      Route::get(
        '/c',
        [\App\Http\Controllers\Customer\CustomerController::class, 'create'],
      )->name('auth.customer.create');

      Route::patch(
        '/u/{customer:cid}',
        [\App\Http\Controllers\Customer\CustomerController::class, 'update'],
      )
      ...
      Route::post(
        '/s',
        [\App\Http\Controllers\Customer\CustomerController::class, 'store'],
      )
      ...
      Route::get(
        '/e/{customer:cid}',
        [\App\Http\Controllers\Customer\CustomerController::class, 'edit'],
      )->name('auth.customer.edit');

      Route::delete(
        '/d/{customer:cid}',
        [\App\Http\Controllers\Customer\CustomerController::class, 'destroy'],
      )
    ...
    Route::group(['prefix' => 'projects'], function () {
      ...
      Route::get(
        '/',
        [\App\Http\Controllers\Projects\ProjectController::class, 'listing'],
      )->name('auth.projects.index');

      Route::get(
        '/c/{customer:cid?}',
        [\App\Http\Controllers\Projects\ProjectController::class, 'create'],
      )->name('auth.projects.create');

      Route::post(
        '/s',
        \App\Http\Controllers\Projects\StoreProject::class,
      )
      ...
      Route::get(
        '/e/{project:pid}',
        [\App\Http\Controllers\Projects\ProjectController::class, 'edit'],
      )->name('auth.projects.edit');

      Route::get(
        '/i/{project:pid}',
        [\App\Http\Controllers\Projects\ProjectController::class, 'detail'],
      )->name('auth.projects.detail');

      Route::put(
        '/u/{project:pid}',
        \App\Http\Controllers\Projects\UpdateProject::class,
      )
      ...
      Route::delete(
        '/d/{project:pid}/{image?}',
        \App\Http\Controllers\Projects\DestroyProject::class,
      )
...
Route::group(['prefix' => 'auth'], function () {
  ...
  Route::group(['prefix' => 'customers'], function () {
    ...
    Route::get(
      '/s/{customer:cid}',
      [\App\Http\Controllers\CustomerController::class, 'show'],
    )->name('auth.customer.show');
